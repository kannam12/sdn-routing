...
class CustomSwitch(simple_switch_13.SimpleSwitch13):
    ...
    topo = nx.read_gml('topo-polska.gml')  #works also for other .gml files, eg. janos
    ...
    def _port_stats_reply_handler(self, ev):
        ...
        # for edge in CustomSwitch.topo.edges(data=True):


        #     for stat in sorted(body, key=attrgetter('port_no')):
        #         current = stat.tx_bytes
        #         current_thr = (edge[2]['bytesTx'] - current)/CustomSwitch.POLLING_INTERVAL

        #     percent = current_thr/CustomSwitch.MAX_THR*100
        #     nowa_waga = percent^2
            
        #     edge[2]['waga'] = nowa_waga
        #     edge[2]['bytesTx'] = current
